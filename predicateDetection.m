...
function [recall50R, recall100R, recall50RD, recall100RD] = ...
predicateDetection(inputFile)
    addpath('evaluation');
    ...
    recall50RD = top_recall_Relationship(50, rlp_confs_ours_dupe, ...
    rlp_labels_ours_dupe, sub_bboxes_ours_dupe, obj_bboxes_ours_dupe);
    recall100RD = top_recall_Relationship(100, rlp_confs_ours_dupe, ...
    rlp_labels_ours_dupe, sub_bboxes_ours_dupe, obj_bboxes_ours_dupe);
    fprintf('Predicate Det. R@50: %0.2f \n', 100 * recall50RD);
    fprintf('Predicate Det. R@100: %0.2f \n', 100 * recall100RD);
end
